...
Helvetic Operations Platform is a portfolio-grade operations control tower for managing work orders across distributed sites. It demonstrates a complete enterprise delivery path with .NET 8, ASP.NET Core Minimal APIs, Entity Framework Core, SQL Server, Angular 22, TypeScript, Microsoft Entra ID, Docker Compose and GitHub Actions.

This is a public .NET/Angular portfolio project. It complements the author's commercial Python background; it does not present that Python experience as prior commercial .NET delivery.
